...
func (b *BaseApi) Login(c *gin.Context) {
	...
	// 判断验证码是否开启
	openCaptcha := global.GVA_CONFIG.Captcha.OpenCaptcha               // 是否开启防爆次数    前n次不需要验证码
...
func (b *BaseApi) ChangePassword(c *gin.Context) {
	...
	u := &system.SysUser{GVA_MODEL: common.GVA_MODEL{ID: uid}, Password: req.Password}
...
func (b *BaseApi) GetUserSettingData(c *gin.Context) {
	id := utils.GetUserID(c)
	data, _ := userService.GetUserSettingData(id)
	//if err != nil {
	//	response.FailWithMessage("获取失败", c)
	//	return
	//}
...
func (b *BaseApi) SetUserSettingData(c *gin.Context) {
	var req system.SysSetting
	...
	err := userService.SetUserSettingData(req)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
