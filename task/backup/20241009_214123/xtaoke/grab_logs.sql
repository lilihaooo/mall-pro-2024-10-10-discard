...
--
-- Table structure for table `grab_logs`
--
...
CREATE TABLE `grab_logs` (
  ...
  `grab_record_uuid` varchar(64) NOT NULL COMMENT '''抓取记录UUID''',
  `level` bigint DEFAULT NULL COMMENT '''基本''',
  `msg` varchar(255) DEFAULT NULL COMMENT '''抓取返回信息''',
...
-- Dump completed on 2024-10-09 13:41:32
